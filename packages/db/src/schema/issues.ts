...
export const issues = pgTable(
  "issues",
  {
    ...
    assigneeUninvokable: boolean("assignee_uninvokable").notNull().default(false),
    assigneeUninvokableAt: timestamp("assignee_uninvokable_at", { withTimezone: true }),
    assigneeUninvokableReason: text("assignee_uninvokable_reason"),
  ...
  (table) => ({
    ...
    assigneeUninvokableIdx: index("issues_company_assignee_uninvokable_idx").on(
      table.companyId,
      table.assigneeUninvokable,
      table.status,
    ),
