...
```sh
scripts/pc-api.sh get "/api/skills/catalog?kind=bundled"

scripts/pc-api.sh get "/api/skills/catalog/ref?ref=github-pr-workflow"

scripts/pc-api.sh post "/api/companies/$PAPERCLIP_COMPANY_ID/skills/install-catalog" '{
...
```sh
scripts/pc-api.sh post "/api/companies/$PAPERCLIP_COMPANY_ID/skills/import" '{
...
```sh
scripts/pc-api.sh post "/api/companies/$PAPERCLIP_COMPANY_ID/skills/scan-projects" '{}'
```

## Inspect What Was Installed

```sh
scripts/pc-api.sh get "/api/companies/$PAPERCLIP_COMPANY_ID/skills"
```

Read the skill entry and its `SKILL.md`:

```sh
scripts/pc-api.sh get "/api/companies/$PAPERCLIP_COMPANY_ID/skills/<skill-id>"

scripts/pc-api.sh get "/api/companies/$PAPERCLIP_COMPANY_ID/skills/<skill-id>/files?path=SKILL.md"
```
...
```sh
scripts/pc-api.sh post "/api/agents/<agent-id>/skills/sync" '{
    "desiredSkills": [
      "vercel-labs/agent-browser/agent-browser"
    ]
  }'
...
```sh
scripts/pc-api.sh get "/api/agents/<agent-id>/skills"
```
...
```sh
scripts/pc-api.sh post "/api/companies/$PAPERCLIP_COMPANY_ID/agents" '{
    "name": "QA Browser Agent",
    "role": "qa",
    "adapterType": "codex_local",
    "adapterConfig": {
