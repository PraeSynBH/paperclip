...
4. **Set up billing** — connect Stripe keys and choose a subscription tier from the **Billing** page to unlock advanced features like API access, advanced agents, and unlimited seats.
