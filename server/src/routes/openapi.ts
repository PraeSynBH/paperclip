...
import {
  ...
  // Plan documents and review gates
...
registerCurrentRoute({
  method: "post",
  path: "/api/issues/{id}/documents/plan",
  tags: ["issues"],
  summary: "Upsert plan document with structured metadata",
  body: upsertPlanDocumentSchema,
...
registerCurrentRoute({
  ...
  path: "/api/issues/{id}/documents/plan",
  tags: ["issues"],
  summary: "Get plan document with parsed metadata",
});

registerCurrentRoute({
  method: "get",
  path: "/api/issues/{id}/documents/plan/revisions",
  tags: ["issues"],
  summary: "List plan document revisions",
});

registry.registerPath({
  method: "get",
  path: "/api/issues/{id}/documents/plan/revisions/{revId}/diff",
  tags: ["issues"],
  summary: "Diff two plan document revisions",
  request: {
    params: z.object({
      id: z.string(),
      revId: z.string().uuid(),
...
registerCurrentRoute({
  method: "post",
  path: "/api/issues/{id}/plan/gates",
  tags: ["issues"],
  summary: "Create a plan review gate",
  body: createPlanReviewGateSchema,
...
registerCurrentRoute({
  ...
  path: "/api/issues/{id}/plan/gates",
  tags: ["issues"],
  summary: "List plan review gates",
  query: planGatesQuerySchema,
});

registerCurrentRoute({
  method: "patch",
  path: "/api/issues/{id}/plan/gates/{gateId}",
  tags: ["issues"],
  summary: "Resolve or reject a plan review gate",
  body: resolvePlanReviewGateSchema,
...
registerCurrentRoute({
  method: "get",
  path: "/api/companies/{companyId}/memory/bindings/resolve",
  tags: ["memory"],
  summary: "Resolve the active memory binding for a company",
  query: resolveMemoryBindingQuerySchema,
});
...
for (const route of [
  ...
  ["get", "/api/companies/{companyId}/memory/targets", "List memory binding targets"],
  ["post", "/api/companies/{companyId}/memory/targets", "Create a memory binding target"],
  ["delete", "/api/companies/{companyId}/memory/targets/{targetId}", "Delete a memory binding target"],
  ["get", "/api/companies/{companyId}/memory/agents/{agentId}/config", "Get resolved memory configuration for an agent"],
  ["post", "/api/companies/{companyId}/memory/capture", "Capture text into memory"],
  ["post", "/api/companies/{companyId}/memory/records", "Upsert curated memory records"],
  ["get", "/api/companies/{companyId}/memory/query", "Search memory records"],
...
registerCurrentRoute({
  method: "get",
  path: "/api/companies/{companyId}/knowledge",
  tags: ["knowledge"],
...
for (const route of [
  ["get", "/api/companies/{companyId}/knowledge/{documentId}", "Get a knowledge document"],
  ["patch", "/api/companies/{companyId}/knowledge/{documentId}", "Update a draft knowledge document"],
  ["delete", "/api/companies/{companyId}/knowledge/{documentId}", "Delete a draft or archived knowledge document"],
  ["post", "/api/companies/{companyId}/knowledge/{documentId}/submit-review", "Submit a draft document for review"],
  ["post", "/api/companies/{companyId}/knowledge/{documentId}/review", "Review a document"],
  ["post", "/api/companies/{companyId}/knowledge/{documentId}/publish", "Publish an approved document"],
  ["post", "/api/companies/{companyId}/knowledge/{documentId}/archive", "Archive a published document"],
