#!/usr/bin/env python3
"""
RBR-614 daily 09:30 PT snapshot (Jul 24, Day 14).

Day 14 — Friday Jul 24, Phase 4 Day 4.
Evidence assembly continues; check if IT processed any Drata retirement tickets.
This is the fourth daily snapshot in the Phase 4 evidence window (Jul 21–28).

Per playbook §3.3, today is Phase 4 Day 4. Actions:
  - Capture fleet + pilot snapshot (same format as RBR-611).
  - Reconcile against RBR-611 (Jul 23) for day-over-day delta.
  ...
  - Emit Phase 4 Day 4 status: evidence assembly continues, 4 days to Jul 28 audit.
...
def main():
    ...
    if pilot_pct >= 90:
        ...
        gate = "ABORT (Phase 1 EOD Jul 11 report; no change at 09:30 PT Jul 24)"

    outstanding_installs = sum(1 for d in devices if d.get("sourceType") != "AGENT")

    # ------------------------------------------------------------------
    # Data reconciliation vs RBR-611 (last snapshot, Jul 23)
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # Residual hand-off (Phase 4 Day 4 — IT continues retirement)
    # ------------------------------------------------------------------
    touched_ids = set()
    ...
    snapshot = {
        ...
        "capturedBy": "secops",
        "capturedFor": "RBR-614 daily 09:30 PT snapshot — Day 14 (Phase 4 Day 4). Evidence assembly continues. 4 days to Jul 28 audit.",
        "scope": "fleet+pilot",
        ...
        "topIssues": [
            f"Day 14 — Phase 4 Day 4 evidence assembly. Cumulative cascade efficacy: {total_moved}/{total_cascade_targets} across 6 cascade days (unchanged). Device-side staleness is the bottleneck, not cascade architecture.",
            f"Fleet strict-compliant count {fleet_compliant}/{baseline_total} ({pct_compliant}%); delta vs Jul 23: agent {delta_with_agent:+d}, compliant {delta_compliant:+d}.",
        ...
        "dataReconciliation": {
            "priorSnapshot": "2026-07-23 (RBR-611 daily 09:30 PT Day 13)",
            ...
            "note": f"Day-over-day delta vs RBR-611 (Jul 23). Phase 4 Day 4. {retirement_note}",
        },
        "cumulativeCascadeEfficacy": {
            ...
            "verdict": (
                ...
                "bottleneck, not cascade architecture. Phase 4 Day 4 focus: continue evidence assembly "
                "for agent-installed devices + monitor IT Drata retirement progress."
            ),
        },
        "residualHandOff": {
            "phase": "Phase 4 Day 4 — IT continues manual Drata retirement",
            ...
            "note": (
                ...
                f"Phase 4 Day 4: {retirement_note}"
            ),
        },
        "phase4EvidenceReadiness": {
            ...
            "recommendation": (
                ...
                "and manual Drata retirement for stale residuals. 4 days remain until Jul 28 Stage 1 audit."
            ),
        },
        "dayNCascadePlan": {
            "day": 4,
            ...
            "phaseDay": 14,
            "action": (
                "Phase 4 Day 4 — evidence assembly continues. Check if IT processed Drata "
            ...
            "nextDayActions": [
                "Jul 25 (Sat): Phase 4 Day 5 — continue evidence assembly; check retirement delta.",
                "Jul 25: Final evidence readiness gate before audit.",
                "Jul 28: Stage 1 audit day — evidence package must be finalized.",
            ],
        },
        "actionsTakenThisDay": [
            "09:30 PT: SecOps captured this RBR-614 Day 14 snapshot (fleet + pilot) via direct Drata API call -- Phase 4 Day 4.",
            "Reconciled day-over-day delta vs RBR-611 (Jul 23).",
            ...
            "Emitted Phase 4 Day 4 evidence readiness assessment (A.8.1, A.8.7, A.8.8).",
        ],
        "nextDayActions": [
            "Jul 25 (Sat): Phase 4 Day 5 — continue evidence assembly.",
            "Jul 25: Check delta on retired devices (Drata index should shrink if retirements processed).",
            "Jul 25: Final evidence readiness gate before Jul 28 Stage 1 audit.",
        ],
    }
    ...
    monitor["rollout"] = {
        "phase": f"Phase 4 — Evidence assembly (Day {14})",
        "owningIssueId": "7ab3a672-3bdc-4233-bf7e-a7b849060082",
        "owningIssueIdentifier": "RBR-614",
    ...
    summary = {
        ...
        "phase": "Phase 4 evidence assembly Day 4 (Day 14)",
